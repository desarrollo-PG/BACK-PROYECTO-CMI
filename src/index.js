...
const repoPacienteRoutes = require('./routes/repoPacienteRoutes');
const repoAgendaRoutes = require('./routes/repoAgendaRoutes');
...
app.use('/api/repoPaciente', repoPacienteRoutes);
app.use('/api/repoAgenda', repoAgendaRoutes);
